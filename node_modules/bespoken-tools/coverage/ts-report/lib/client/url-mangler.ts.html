...
<html lang="en">
<head>
    <title>Code coverage report for lib/client/url-mangler.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">lib/client/</a> url-mangler.ts
    </h1>
    <div class='clearfix'>
...
32
33
34</td><td class="line-coverage quiet"><span class="cline-any cline-yes">11×</span>
...
<span class="cline-any cline-yes">3×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import * as url from "url";
import {Url} from "url";
