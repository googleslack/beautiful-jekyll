...
<html lang="en">
<head>
    <title>Code coverage report for lib/client/bst-alexa.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">lib/client/</a> bst-alexa.ts
    </h1>
    <div class='clearfix'>
...
292
293
294</td><td class="line-coverage quiet"><span class="cline-any cline-yes">3×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import {InteractionModel} from "../alexa/interaction-model";
...
&nbsp;
            <span class="missing-if-branch" title="else path not taken" >E</span>if (this._alexa.context().audioPlayerEnabled()) {
...
&nbsp;
    ...
    public spoken(phrase: string, callback?: (error: any, response: any, request: any) =&gt; void): BSTAlexa {
        this._alexa.spoken(phrase, function (error: any, response: any, request: any) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (callback !== undefined &amp;&amp; callback !== null) {
...
&nbsp;
    ...
    public playbackFinished(callback?: (error: any, response: any, request: any) =&gt; void): BSTAlexa {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this._alexa.context().audioPlayerEnabled()) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (this._alexa.context().audioPlayer().isPlaying()) {
