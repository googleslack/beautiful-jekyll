...
<html lang="en">
<head>
    <title>Code coverage report for lib/alexa/alexa-session.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">lib/alexa/</a> alexa-session.ts
    </h1>
    <div class='clearfix'>
...
34
35
36</td><td class="line-coverage quiet"><span class="cline-any cline-yes">3×</span>
...
<span class="cline-any cline-yes">45×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const uuid = require("node-uuid");
&nbsp;
