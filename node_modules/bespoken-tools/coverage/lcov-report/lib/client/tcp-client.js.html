...
<html lang="en">
<head>
    <title>Code coverage report for lib/client/tcp-client.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">lib/client/</a> tcp-client.js
    </h1>
    <div class='clearfix'>
...
class TCPClient {
    ...
    transmit(host, port, data, callback) {
        ...
        client.on("error", function (e) {
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (e.code === "ECONNREFUSED") {
                callback(null, global_1.NetworkErrorType.CONNECTION_REFUSED, e.message);
            }
            else {
<span class="cstat-no" title="statement not covered" >                callback(null, global_1.NetworkErrorType.OTHER, e.message);</span>
            }
        });
...
//# sourceMappingURL=tcp-client.js.map</pre></td></tr>
</table></pre>
