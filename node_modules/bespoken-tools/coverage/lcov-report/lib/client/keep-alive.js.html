...
<html lang="en">
<head>
    <title>Code coverage report for lib/client/keep-alive.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">lib/client/</a> keep-alive.js
    </h1>
    <div class='clearfix'>
...
class KeepAlive {
    ...
    stop() {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.timeout !== null) {
            clearTimeout(this.timeout);
        }
    }
}
exports.KeepAlive = KeepAlive;
//# sourceMappingURL=keep-alive.js.map</pre></td></tr>
</table></pre>
