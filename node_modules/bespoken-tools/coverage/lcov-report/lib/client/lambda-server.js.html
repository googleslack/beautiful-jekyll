...
<html lang="en">
<head>
    <title>Code coverage report for lib/client/lambda-server.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">lib/client/</a> lambda-server.js
    </h1>
    <div class='clearfix'>
...
class LambdaServer {
    ...
    start(callback) {
        ...
        this.server.on("listening", function () {
            logging_helper_1.LoggingHelper.info(Logger, "LambdaServer started on port: " + self.server.address().port.toString());
...
//# sourceMappingURL=lambda-server.js.map</pre></td></tr>
</table></pre>
