...
<html lang="en">
<head>
    <title>Code coverage report for lib/client/bst-proxy.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">lib/client/</a> bst-proxy.js
    </h1>
    <div class='clearfix'>
...
class BSTProxy {
    ...
    stop(onStopped) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.bespokenClient !== null) {
        ...
        if (this.lambdaServer !== null) {
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (onStopped !== undefined &amp;&amp; onStopped !== null) {
                onStopped();
            }
        }
    }
...
//# sourceMappingURL=bst-proxy.js.map</pre></td></tr>
</table></pre>
