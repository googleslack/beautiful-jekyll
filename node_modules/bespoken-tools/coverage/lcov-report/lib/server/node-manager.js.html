...
<html lang="en">
<head>
    <title>Code coverage report for lib/server/node-manager.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">lib/server/</a> node-manager.js
    </h1>
    <div class='clearfix'>
...
class NodeManager {
    ...
    start(callback) {
        ...
        this.server = net.createServer(function (socket) {
            ...
            let socketHandler = new socket_handler_1.SocketHandler(socket, function (message, messageID) {
                ...
                else <span class="missing-if-branch" title="else path not taken" >E</span>if (node.handlingRequest()) {
    ...
    static onKeepAliveReceived<span class="fstat-no" title="function not covered" >(node) {</span>
<span class="cstat-no" title="statement not covered" >        node.socketHandler.send(global_1.Global.KeepAliveMessage);</span>
    }
    stop(callback) {
...
<span class="cstat-no" title="statement not covered" >                logging_helper_1.LoggingHelper.error(Logger, "ERROR! NodeManager not stopped: " + error);</span>
            }
            else {
...
//# sourceMappingURL=node-manager.js.map</pre></td></tr>
</table></pre>
