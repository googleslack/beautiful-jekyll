...
<html lang="en">
<head>
    <title>Code coverage report for lib/core/http-buffer.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">lib/core/</a> http-buffer.js
    </h1>
    <div class='clearfix'>
...
class HTTPBuffer {
    ...
    header(headerKey) {
        let value = null;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this._headers !== undefined &amp;&amp; this.hasHeader(headerKey)) {
    ...
    chunked() {
        let chunked = false;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.complete()) {
    ...
    bodyAsJSON() {
        let json;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.body() !== undefined) {
...
//# sourceMappingURL=http-buffer.js.map</pre></td></tr>
</table></pre>
