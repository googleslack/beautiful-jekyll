...
<html lang="en">
<head>
    <title>Code coverage report for lib/core/webhook-request.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">lib/core/</a> webhook-request.js
    </h1>
    <div class='clearfix'>
...
class WebhookRequest {
    ...
    append(data) {
        ...
        if (this.headers == null) {
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (endIndex !== -1) {
    ...
    contentLength() {
        let contentLength = -1;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.headers != null) {
...
//# sourceMappingURL=webhook-request.js.map</pre></td></tr>
</table></pre>
