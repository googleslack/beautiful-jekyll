...
<html lang="en">
<head>
    <title>Code coverage report for bespoke-server/bin/bst-speak.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">bespoke-server/bin/</a> bst-speak.js
    </h1>
    <div class='clearfix'>
...
const bst_speak_1 = require("../lib/client/bst-speak");
...
program
    ...
    let speaker = new bst_speak_1.BSTSpeak(url, intentSchemaPath, samplesPath, null);
    speaker.initialize(function (error) {
        ...
        speaker.spoken(utterance, function (request, response) {
...
<span class="missing-if-branch" title="if path not taken" >I</span>if (process.argv.slice(2).length === 0) {
<span class="cstat-no" title="statement not covered" >    program.outputHelp();</span>
}
program.parse(process.argv);
//# sourceMappingURL=bst-speak.js.map</pre></td></tr>
</table></pre>
