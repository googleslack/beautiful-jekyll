...
<html lang="en">
<head>
    <title>Code coverage report for bespoke-server/lib/core/logging-helper.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">bespoke-server/lib/core/</a> logging-helper.js
    </h1>
    <div class='clearfix'>
...
class LoggingHelper {
    ...
    static formatter(options) {
        return new Date().toISOString() + " "
            ...
            + (undefined !== options.message ? options.message : <span class="branch-1 cbranch-no" title="branch not covered" >"")</span>
            + (options.meta &amp;&amp; Object.keys(options.meta).length ? <span class="branch-0 cbranch-no" title="branch not covered" >"\n\t"</span>
...
//# sourceMappingURL=logging-helper.js.map</pre></td></tr>
</table></pre>
