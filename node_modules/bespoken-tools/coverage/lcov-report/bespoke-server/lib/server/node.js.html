...
<html lang="en">
<head>
    <title>Code coverage report for bespoke-server/lib/server/node.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">bespoke-server/lib/server/</a> node.js
    </h1>
    <div class='clearfix'>
...
class Node {
    ...
    onReply(message, messageID) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (request === null) {
<span class="cstat-no" title="statement not covered" >            logging_helper_1.LoggingHelper.info(Logger, "No matching messageID for reply: " + messageID);</span>
        }
        else {
