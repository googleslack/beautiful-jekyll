...
<html lang="en">
<head>
    <title>Code coverage report for bespoke-server/lib/client/lambda-runner.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">bespoke-server/lib/client/</a> lambda-runner.js
    </h1>
    <div class='clearfix'>
    ...
    start(callback) {
        ...
        this.watcher = fs.watch(process.cwd(), watchOptions, function (event, filename) {
            ...
            if (!exclude) {
                ...
                self.dirty = true;
                <span class="missing-if-branch" title="else path not taken" >E</span>if (self.onDirty !== undefined &amp;&amp; self.onDirty !== null) {
        ...
        this.server.on("listening", function () {
            logging_helper_1.LoggingHelper.info(Logger, "LambdaRunner started on port: " + self.server.address().port.toString());
            if (callback !== undefined &amp;&amp; callback !== null) {
                callback();
            }
        });
    }
    invoke(body, response) {
        let path = this.file;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!path.startsWith("/")) {
            path = [process.cwd(), this.file].join("/");
        }
        logging_helper_1.LoggingHelper.info(Logger, "Invoking Lambda: " + this.file);
        if (this.lambda === null || this.dirty) {
            this.lambda = node_util_1.NodeUtil.load(path);
            this.dirty = false;
        }
        let context = new LambdaContext(response, this.verbose);
        try {
...
//# sourceMappingURL=lambda-runner.js.map</pre></td></tr>
</table></pre>
